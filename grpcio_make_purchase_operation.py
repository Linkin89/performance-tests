...
accounts_gateway_service = AccountsGatewayServiceStub(channel=channel)
operation_gateway_service = OperationsGatewayServiceStub(channel=channel)
...
make_purchase_operation_response: MakePurchaseOperationResponse = operation_gateway_service.MakePurchaseOperation(
