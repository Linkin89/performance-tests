...
open_saving_account_request = OpenSavingsAccountRequest(user_id=user_id)
open_saving_account_response: OpenSavingsAccountResponse = accounts_gateway_service.OpenCreditCardAccount(
    open_saving_account_request)
